...
export const metadata = {
  ...
  twitter: {
    ...
    images: [PRESS_ARTICLES[0].banner],
  },
};

export default function PressPage() {
  const [featured, ...rest] = PRESS_ARTICLES;
      ...
      <main>
          ...
          <div className="wrap">
            ...
            <div style={{
              ...
              <div>
                ...
                <a
                  href="mailto:press@adaptglobal.io"
                  className="press-contact-pill"
                  style={{
            ...
            <div style={{
              ...
              {[
                { n: String(PRESS_ARTICLES.length), label: 'press releases' },
                { n: '3', label: 'industry awards' },
                { n: '2', label: 'Top 100 lists' },
                { n: '5+', label: 'strategic partnerships' },
              ].map(({ n, label }) => (
                <div key={label}>
                  <div style={{ fontSize: 'clamp(28px, 4vw, 48px)', fontFamily: 'var(--serif)', fontWeight: 400, lineHeight: 1 }}>
                    {n}
                  </div>
                  <div style={{ fontFamily: 'var(--mono)', fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--fg-3)', marginTop: 6 }}>
                    {label}
                  </div>
                </div>
              ))}
        ...
        <section style={{ paddingBottom: 'clamp(48px, 5vw, 80px)' }}>
          <div className="wrap">
            ...
            <a
              href={featured.externalUrl || `/press/${featured.slug}`}
            ...
            >
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ fontSize: 15, color: 'var(--fg-2)', lineHeight: 1.6, maxWidth: '52ch' }}>
                    {featured.excerpt}
                  </p>
                </div>
                <div style={{
        ...
        <section className="section-pad" style={{ paddingTop: 0 }}>
          <div className="wrap">
            <div style={{
              ...
              {rest.map(article => (
                <PressCard key={article.slug} article={article} />
              ))}
            </div>
          </div>
        </section>
            ...
            <div style={{
              ...
              <div>
                ...
                <h3 style={{ fontSize: 'clamp(22px, 3vw, 36px)', fontFamily: 'var(--serif)', fontWeight: 400, lineHeight: 1.2, marginBottom: 8 }}>
                  Covering Adapt?<br />
                  <span className="italic-serif" style={{ color: 'var(--accent)' }}>Let&apos;s connect.</span>
                </h3>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, minWidth: 220 }}>
                ...
                <a
                  href="https://adaptglobal.io/brand/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="press-brand-btn"
                  style={{
...
function PressCard({ article }) {
  const href = article.externalUrl || `/press/${article.slug}`;
    ...
    >
      ...
      <div style={{ padding: 'clamp(16px, 2vw, 24px)', display: 'flex', flexDirection: 'column', flex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, flexWrap: 'wrap' }}>
          ...
          <span style={{ fontFamily: 'var(--mono)', fontSize: 10, letterSpacing: '0.1em', color: 'var(--fg-3)', textTransform: 'uppercase' }}>
